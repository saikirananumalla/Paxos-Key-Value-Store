...
public class RequestHandler {
    ...
    switch (action.getOperation()) {
      case PUT:
        ...
        if (resp) {
          ...
          LOGGER.info("Failed. Put Value: " + value + " for Key : " + key);
        }
        break;
      case DELETE:
        ...
        if (delResp) {
          ...
          LOGGER.info("Failed. Delete for Key : " + key);
        }
        break;
      case GET:
  ...
  public static void prePopulateStore(KeyValueService keyValueService) throws IOException {
    String[] keys = {"name", "city", "course", "language", "IDE", "Project"};
    String[] values = {"Sai", "Boston", "CS6650", "Java", "IntelliJ", "Paxos"};
